...
func EnableObservability() error {
	...
	// Please see https://github.com/Basechain-Network/Basechain/v2/issues/84
	// return nil
	// }

	// pe, err := prometheus.NewExporter(prometheus.Options{
	// 	Namespace: "basechaind",
	// })
	// if err != nil {
	...
	// // TODO: Derive the Prometheus observability exporter from the basechain config.
	// addr := ":8877"
	// go func() {
