...
func init() {
	proto.RegisterType((*Input)(nil), "basechain.coinswap.v1.Input")
	proto.RegisterType((*Output)(nil), "basechain.coinswap.v1.Output")
	proto.RegisterType((*Pool)(nil), "basechain.coinswap.v1.Pool")
	proto.RegisterType((*Params)(nil), "basechain.coinswap.v1.Params")
}

func init() { proto.RegisterFile("basechain/coinswap/v1/coinswap.proto", fileDescriptor_b57883b6d1fc5094) }
