...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "basechain.coinswap.v1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "basechain.coinswap.v1.QueryParamsResponse")
	proto.RegisterType((*QueryLiquidityPoolRequest)(nil), "basechain.coinswap.v1.QueryLiquidityPoolRequest")
	proto.RegisterType((*QueryLiquidityPoolResponse)(nil), "basechain.coinswap.v1.QueryLiquidityPoolResponse")
	proto.RegisterType((*QueryLiquidityPoolsRequest)(nil), "basechain.coinswap.v1.QueryLiquidityPoolsRequest")
	proto.RegisterType((*QueryLiquidityPoolsResponse)(nil), "basechain.coinswap.v1.QueryLiquidityPoolsResponse")
	proto.RegisterType((*PoolInfo)(nil), "basechain.coinswap.v1.PoolInfo")
}

func init() { proto.RegisterFile("basechain/coinswap/v1/query.proto", fileDescriptor_670b91810fb3a899) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/basechain.coinswap.v1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) LiquidityPool(ctx context.Context, in *QueryLiquidityPoolRequest, opts ...grpc.CallOption) (*QueryLiquidityPoolResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/basechain.coinswap.v1.Query/LiquidityPool", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) LiquidityPools(ctx context.Context, in *QueryLiquidityPoolsRequest, opts ...grpc.CallOption) (*QueryLiquidityPoolsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/basechain.coinswap.v1.Query/LiquidityPools", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/basechain.coinswap.v1.Query/Params",
	}
...
func _Query_LiquidityPool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/basechain.coinswap.v1.Query/LiquidityPool",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_LiquidityPools_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/basechain.coinswap.v1.Query/LiquidityPools",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
