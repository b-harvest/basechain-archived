...
func init() {
	proto.RegisterType((*EpochInfo)(nil), "basechain.epochs.v1.EpochInfo")
	proto.RegisterType((*GenesisState)(nil), "basechain.epochs.v1.GenesisState")
}

func init() { proto.RegisterFile("basechain/epochs/v1/genesis.proto", fileDescriptor_215c7e170263b152) }
