...
func init() {
	proto.RegisterType((*Params)(nil), "basechain.govshuttle.v1.Params")
	proto.RegisterType((*LendingMarketProposal)(nil), "basechain.govshuttle.v1.LendingMarketProposal")
	proto.RegisterType((*TreasuryProposal)(nil), "basechain.govshuttle.v1.TreasuryProposal")
	proto.RegisterType((*TreasuryProposalMetadata)(nil), "basechain.govshuttle.v1.TreasuryProposalMetadata")
	proto.RegisterType((*LendingMarketMetadata)(nil), "basechain.govshuttle.v1.LendingMarketMetadata")
}

func init() {
	proto.RegisterFile("basechain/govshuttle/v1/govshuttle.proto", fileDescriptor_39f3a63fcc428040)
}
