...
func init() {
	proto.RegisterType((*GenesisState)(nil), "basechain.inflation.v1.GenesisState")
	proto.RegisterType((*Params)(nil), "basechain.inflation.v1.Params")
}

func init() { proto.RegisterFile("basechain/inflation/v1/genesis.proto", fileDescriptor_5da850aabf0c3ac5) }
