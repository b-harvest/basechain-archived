...
func init() {
	proto.RegisterType((*InflationDistribution)(nil), "basechain.inflation.v1.InflationDistribution")
	proto.RegisterType((*ExponentialCalculation)(nil), "basechain.inflation.v1.ExponentialCalculation")
}

func init() {
	proto.RegisterFile("basechain/inflation/v1/inflation.proto", fileDescriptor_aa2aa1764b029465)
}
